...
const quizData = {
    mcq: [
        ...
        { id: 13, question: "According to operator precedence in Python, which operation is performed first?", options: ["Addition and subtraction", "Multiplication and division", "Exponents"], correct: 2, explanation: "Exponentiation (**) has the highest precedence, then multiplication/division, then addition/subtraction." },
